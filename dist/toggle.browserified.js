	    ...
	    render: function() {
	      ...
	      return (
	        React.createElement("div", {className: "toggle-button"}, 
	          React.createElement("input", {type: "submit", style: onStateButtonStyle, className: "btn btn-on", value: onStateTextValue}), 
	  				React.createElement("input", {type: "submit", style: offStateButtonStyle, className: "btn btn-off", value: offStateTextValue})
	        )
	      );
	    }
	  });
	    ...
	    render: function() {
	      return (
	        React.createElement("div", {className: "toggle-button-component"}, 
		        React.createElement(ToggleButton, {opts: this.props.opts})
		      )
	      );
	    }
	  });
...
},{"jquery":29,"react":160,"react-dom":31}]},{},[1]);
