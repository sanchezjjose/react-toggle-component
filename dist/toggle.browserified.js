  ...
  function renderToggleButtonComponent(domElement, isActive, onStateHttpRequest, offStateHttpRequest, callback, opts) {
      ...
      render: function() {
        ...
        return (
          React.createElement("div", null, 
            React.createElement("p", {className: "onText status", style: onStateTextStyle}, " ", onStateTextValue, " "), 
            React.createElement("p", {className: "offText status", style: offStateTextStyle}, " ", offStateTextValue, " ")
          )
        );
      }
    });
    ...
    var InputComponent = React.createClass({displayName: "InputComponent",
      ...
      render: function() {
        ...
        return (
          React.createElement("input", {className: "toggleButton", name: "secret", type: "checkbox", style: inputStyles}) 
        );
      }
    });

    var ToggleButtonComponent = React.createClass({displayName: "ToggleButtonComponent",
      ...
      handleClick: function() {
        ...
        var toggleButtonStyles = $.extend({}, styles.base, this.state.isActive && styles.active);
	      ...
	      return (
          React.createElement("div", {className: "toggleButton", onClick: this.handleClick, style: toggleButtonStyles}, 
            React.createElement(SliderComponent, {isActive: this.state.isActive}), 
            React.createElement(TextComponent, {isActive: this.state.isActive, opts: this.props.opts}), 
            React.createElement(InputComponent, {isActive: this.state.isActive})
          )
	      );
	    }
	  });
	  ...
	  ReactDOM.render(
      React.createElement(ToggleButtonComponent, {opts: opts}),
      domElement
    );
  }
...
},{"jquery":3,"react":160,"react-dom":4}]},{},[1]);
